...
# ---------------------------------------------------------------------------
# Each entry is an (x, y) tuple.  # TODO: measure from screenshots

# World screen → Guild hall
...
TEMPLATE_GUILD_HALL: Final[str] = "guild_hall.png"
TEMPLATE_GUILD_MEMBER_LIST: Final[str] = "guild_member_list.png"
